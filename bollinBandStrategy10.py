...
import math
from json_strategy_file_handle import json_strategy_file_handle
from load_data_days import load_data_days
...
# load custom data
# with open('data_one_day.json') as today_file:
#     t_f = json.load(today_file)
#     t_f = pd.json_normalize(t_f,current_product)
#     f = t_f 
...
############  LOAD DATA FILES  ######################
######################################################
f = load_data_days(current_product)
...
####################################################################################################
# strategy_lower_bolling_lvl = 2.332
# strategy_upper_bolling_lvl = 2.248
# strategy_STD = 21
# strategy_SMA = 25
# min_market_funds = 10
# max_buys = 50
...
#dump buys to file for anal
# buys_file = product_folder+'/'+current_product+'-anal-buys.json'
# with open(buys_file,'w') as json_dump_file: 
